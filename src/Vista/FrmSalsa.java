...
public final class FrmSalsa extends javax.swing.JFrame {
    ...
    String nombre;
        ...
        // Llamar al método agregarSalsa del controlador
        if (controlador.agregarSalsa(nombre, precio)) {
            // Limpiar la tabla para evitar duplicados al mostrar
            dtm.setRowCount(0);
        ...
        private void inicializarValidacionCampos() {
        // Validación para el campo txtNombre: no permitir números
        txtNombre.addKeyListener(new java.awt.event.KeyAdapter() {
            @Override
            public void keyTyped(java.awt.event.KeyEvent evt) {
                char c = evt.getKeyChar();
                // Si el carácter es un dígito, consumimos el evento y mostramos el mensaje.
                if (Character.isDigit(c)) {
                    evt.consume();
                    javax.swing.JOptionPane.showMessageDialog(null, "No se pueden ingresar números en el campo de nombre.");
                }
            }
        });
        // Validación para el campo txtPrecio: no permitir letras
        txtPrecio.addKeyListener(new java.awt.event.KeyAdapter() {
            @Override
            public void keyTyped(java.awt.event.KeyEvent evt) {
                char c = evt.getKeyChar();
                // Si el carácter no es un dígito, consumimos el evento y mostramos el mensaje.
                if (!Character.isDigit(c)) {
                    evt.consume();
                    javax.swing.JOptionPane.showMessageDialog(null, "Solo se pueden ingresar números en el campo de precio.");
                }
            }
        });
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (controlador.actualizarSalsa(id, nombre, precio)) {
            dtm.setRowCount(0);
            controlador.llenarTablaConListaSalsas(dtm, tblTabla);
        }
        btnLimpiarActionPerformed(evt);
